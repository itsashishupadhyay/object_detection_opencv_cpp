...
void help_menu() {
    ...
    std::cout << "  ./program_name -o -p /path/to/image.jpg -l /path/to/label.txt -m /path/to/model.onnx\n";
}
...
int main(int argc, char** argv) {
    ...
    if (!imageFlag && !videoFlag && !webcamFlag && !object_detection) {
        std::cout << "Error: Either -i/--image or -v/--video or -w/--webcam or -o/--object flag must be specified.\n";
        return 1;
    }
